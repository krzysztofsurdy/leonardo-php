...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LoraNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CedricZiel\LeonardoAI\Generated\Model\Lora::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === CedricZiel\LeonardoAI\Generated\Model\Lora::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\LeonardoAI\Generated\Model\Lora();
            ...
            if (\array_key_exists('baseModel', $data) && $data['baseModel'] !== null) {
                $object->setBaseModel($data['baseModel']);
                unset($data['baseModel']);
            } elseif (\array_key_exists('baseModel', $data) && $data['baseModel'] === null) {
                $object->setBaseModel(null);
            }
            ...
            if (\array_key_exists('__typename', $data)) {
                $object->setTypename($data['__typename']);
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('typename') && null !== $object->getTypename()) {
                $data['__typename'] = $object->getTypename();
            }
        ...
        {
            return [\CedricZiel\LeonardoAI\Generated\Model\Lora::class => false];
        }
    }
} else {
    class LoraNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
