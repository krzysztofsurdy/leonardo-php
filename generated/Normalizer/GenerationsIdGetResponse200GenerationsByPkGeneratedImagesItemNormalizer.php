...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GenerationsIdGetResponse200GenerationsByPkGeneratedImagesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CedricZiel\LeonardoAI\Generated\Model\GenerationsIdGetResponse200GenerationsByPkGeneratedImagesItem::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === CedricZiel\LeonardoAI\Generated\Model\GenerationsIdGetResponse200GenerationsByPkGeneratedImagesItem::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\LeonardoAI\Generated\Model\GenerationsIdGetResponse200GenerationsByPkGeneratedImagesItem();
            ...
            if (\array_key_exists('generated_image_variation_generics', $data)) {
                ...
                foreach ($data['generated_image_variation_generics'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \CedricZiel\LeonardoAI\Generated\Model\GenerationsIdGetResponse200GenerationsByPkGeneratedImagesItemGeneratedImageVariationGenericsItem::class, 'json', $context);
                }
        ...
        {
            return [\CedricZiel\LeonardoAI\Generated\Model\GenerationsIdGetResponse200GenerationsByPkGeneratedImagesItem::class => false];
        }
    }
} else {
    class GenerationsIdGetResponse200GenerationsByPkGeneratedImagesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
