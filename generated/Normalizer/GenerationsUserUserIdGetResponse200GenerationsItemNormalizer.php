...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GenerationsUserUserIdGetResponse200GenerationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CedricZiel\LeonardoAI\Generated\Model\GenerationsUserUserIdGetResponse200GenerationsItem::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === CedricZiel\LeonardoAI\Generated\Model\GenerationsUserUserIdGetResponse200GenerationsItem::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\LeonardoAI\Generated\Model\GenerationsUserUserIdGetResponse200GenerationsItem();
            ...
            if (\array_key_exists('generated_images', $data)) {
                ...
                foreach ($data['generated_images'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \CedricZiel\LeonardoAI\Generated\Model\GenerationsUserUserIdGetResponse200GenerationsItemGeneratedImagesItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('generation_elements', $data)) {
                ...
                foreach ($data['generation_elements'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \CedricZiel\LeonardoAI\Generated\Model\GenerationsUserUserIdGetResponse200GenerationsItemGenerationElementsItem::class, 'json', $context);
                }
        ...
        {
            return [\CedricZiel\LeonardoAI\Generated\Model\GenerationsUserUserIdGetResponse200GenerationsItem::class => false];
        }
    }
} else {
    class GenerationsUserUserIdGetResponse200GenerationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
