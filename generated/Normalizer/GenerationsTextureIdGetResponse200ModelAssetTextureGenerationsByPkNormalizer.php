...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GenerationsTextureIdGetResponse200ModelAssetTextureGenerationsByPkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CedricZiel\LeonardoAI\Generated\Model\GenerationsTextureIdGetResponse200ModelAssetTextureGenerationsByPk::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === CedricZiel\LeonardoAI\Generated\Model\GenerationsTextureIdGetResponse200ModelAssetTextureGenerationsByPk::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CedricZiel\LeonardoAI\Generated\Model\GenerationsTextureIdGetResponse200ModelAssetTextureGenerationsByPk();
            ...
            if (\array_key_exists('model_asset_texture_images', $data)) {
                ...
                foreach ($data['model_asset_texture_images'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \CedricZiel\LeonardoAI\Generated\Model\GenerationsTextureIdGetResponse200ModelAssetTextureGenerationsByPkModelAssetTextureImagesItem::class, 'json', $context);
                }
        ...
        {
            return [\CedricZiel\LeonardoAI\Generated\Model\GenerationsTextureIdGetResponse200ModelAssetTextureGenerationsByPk::class => false];
        }
    }
} else {
    class GenerationsTextureIdGetResponse200ModelAssetTextureGenerationsByPkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
