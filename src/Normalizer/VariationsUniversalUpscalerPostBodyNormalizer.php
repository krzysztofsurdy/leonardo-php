...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VariationsUniversalUpscalerPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \LeonardoAI\Model\VariationsUniversalUpscalerPostBody::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \LeonardoAI\Model\VariationsUniversalUpscalerPostBody::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \LeonardoAI\Model\VariationsUniversalUpscalerPostBody();
        ...
        {
            return [\LeonardoAI\Model\VariationsUniversalUpscalerPostBody::class => false];
        }
    }
} else {
    class VariationsUniversalUpscalerPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
