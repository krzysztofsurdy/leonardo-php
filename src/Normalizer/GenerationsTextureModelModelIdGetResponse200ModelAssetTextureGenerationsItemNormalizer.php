...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GenerationsTextureModelModelIdGetResponse200ModelAssetTextureGenerationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \LeonardoAI\Model\GenerationsTextureModelModelIdGetResponse200ModelAssetTextureGenerationsItem::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \LeonardoAI\Model\GenerationsTextureModelModelIdGetResponse200ModelAssetTextureGenerationsItem::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \LeonardoAI\Model\GenerationsTextureModelModelIdGetResponse200ModelAssetTextureGenerationsItem();
            ...
            if (\array_key_exists('model_asset_texture_images', $data)) {
                ...
                foreach ($data['model_asset_texture_images'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \LeonardoAI\Model\GenerationsTextureModelModelIdGetResponse200ModelAssetTextureGenerationsItemModelAssetTextureImagesItem::class, 'json', $context);
                }
        ...
        {
            return [\LeonardoAI\Model\GenerationsTextureModelModelIdGetResponse200ModelAssetTextureGenerationsItem::class => false];
        }
    }
} else {
    class GenerationsTextureModelModelIdGetResponse200ModelAssetTextureGenerationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
