...
class LcmUpscalePostBody extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * @var bool|null
     */
    protected $refineCreative;
    /**
     * Must be a float between 0.5 and 0.9.
     *
     * @var float|null
     */
    protected $refineStrength;
     ...
     * Refine creative.
     */
    public function getRefineCreative(): ?bool
    {
        return $this->refineCreative;
    }

    /**
     * Refine creative.
     */
    public function setRefineCreative(?bool $refineCreative): self
    {
        $this->initialized['refineCreative'] = true;
     ...
     * Must be a float between 0.5 and 0.9.
     */
    public function getRefineStrength(): ?float
    {
        return $this->refineStrength;
    }

    /**
     * Must be a float between 0.5 and 0.9.
     */
    public function setRefineStrength(?float $refineStrength): self
    {
        $this->initialized['refineStrength'] = true;
